...
class PoincareBall(Manifold):
    ...
    def logmap(self, p1, p2, c):
        ...
        sub_norm = sub.norm(dim=-1, p=2, keepdim=True).clamp_min(self.min_norm).clamp_max(self.max_norm)
    ...
    def expmap0(self, u, c):
        sqrt_c = c ** 0.5
        u_norm = torch.clamp_max(torch.clamp_min(u.norm(dim=-1, p=2, keepdim=True), self.min_norm), self.max_norm)
    ...
    def mobius_add(self, x, y, c, dim=-1):
        ...
        out = num / denom.clamp_min(self.min_norm)
